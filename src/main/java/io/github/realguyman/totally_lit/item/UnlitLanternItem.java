...
public class UnlitLanternItem extends BlockItem {
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (pos != null && (world.getBlockState(pos).isIn(TagRegistry.LANTERN_IGNITER_BLOCKS) || world.getFluidState(pos.offset(context.getSide())).isIn(TagRegistry.LANTERN_IGNITER_FLUIDS))) {
