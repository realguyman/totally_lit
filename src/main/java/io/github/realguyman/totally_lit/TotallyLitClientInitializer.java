...
public class TotallyLitClientInitializer implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        BlockRenderLayerMap.INSTANCE.putBlocks(RenderLayer.getCutout(), GLOWSTONE_LANTERN, GLOWSTONE_TORCH, GLOWSTONE_WALL_TORCH, UNLIT_LANTERN, UNLIT_TORCH, UNLIT_WALL_TORCH);
    }
}
